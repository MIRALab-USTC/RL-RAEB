...
class SACPlanningTrainer(SACTrainer):
    def __init__(
            self,
            env,
            policy,
        ...
        self.agent = SAC(d_state, d_action, policy_replay_size, policy_batch_size, policy_active_updates, policy_n_hidden, discount, alpha, policy_lr, soft_target_tau)
