...
class BatchTorchTrainer(Trainer, metaclass=abc.ABCMeta):
    ...
    def train_model(self, data):
        return self.train_model_from_numpy_batch(data)

    def train_model_from_numpy_batch(self, np_batch):
        self._num_train_model_steps += 1
        batch = ptu.np_to_pytorch_batch(np_batch)
        return self.train_model_from_torch_batch(batch)
