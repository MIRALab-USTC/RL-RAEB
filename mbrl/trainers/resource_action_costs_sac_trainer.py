...
class ResourceActionCostSACTrainer(SACTrainer):
    def __init__(
        self,
        *sac_kwarg,
        resource_action_cost_coeff=10.0,
        **sac_kwargs
    ):
        SACTrainer.__init__(self, *sac_kwarg, **sac_kwargs)
        self.resource_action_cost_coeff = resource_action_cost_coeff
        

    def _get_costs(self, states, actions):
    ...
    def train_from_torch_batch(self, batch):
        ...
        resource_action_costs = self._get_costs(obs, actions)
        rewards = rewards - self.resource_action_cost_coeff * resource_action_costs
