...
class TransitionNormalizer:
    def __init__(self, mean_std_dict):
        ...
        self.state_stdev = mean_std_dict['obs_std']
        self.action_mean = mean_std_dict['ac_mean']
        self.action_stdev = mean_std_dict['ac_std']
        self.state_delta_mean = mean_std_dict['obs_delta_mean']
        self.state_delta_stdev = mean_std_dict['obs_delta_std']
        self.count = 0       
