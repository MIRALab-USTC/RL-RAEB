#!/bin/bash
CUDA_VISIBLE_DEVICES=3 nohup python scripts/run.py configs/sac/sac_ant_maze/ant_corridor/sac_goal7.json > sac_goal71.txt 2>&1 &
sleep 15s
CUDA_VISIBLE_DEVICES=3 nohup python scripts/run.py configs/sac/sac_ant_maze/ant_corridor/sac_goal7.json > sac_goal72.txt 2>&1 &
sleep 15s
