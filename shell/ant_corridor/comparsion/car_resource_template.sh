#!/bin/bash
CUDA_VISIBLE_DEVICES=4 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_small_model.json --env_name resource_mountaincar_v0  --base_log_dir /home/zhwang/research/ICML_data/mountain_car_small_model/continuous_resource_10/surprise_small_model_train_freq_low > surprise_10_1.txt 2>&1 &
sleep 15s
CUDA_VISIBLE_DEVICES=4 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_small_model.json  --env_name resource_mountaincar_v0 --base_log_dir /home/zhwang/research/ICML_data/mountain_car_small_model/continuous_resource_10/surprise_small_model_train_freq_low > surprise_10_2.txt 2>&1 &
sleep 15s

CUDA_VISIBLE_DEVICES=5 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision_small_model.json  --env_name resource_mountaincar_v0  --base_log_dir /home/zhwang/research/ICML_data/mountain_car_small_model/continuous_resource_10/surprise_vision_small_model_train_freq_low > surprise_vision_10_1.txt 2>&1 &
sleep 15s
CUDA_VISIBLE_DEVICES=5 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision_small_model.json  --env_name resource_mountaincar_v0  --base_log_dir /home/zhwang/research/ICML_data/mountain_car_small_model/continuous_resource_10/surprise_vision_small_model_train_freq_low > surprise_vision_10_2.txt 2>&1 &
sleep 15s
CUDA_VISIBLE_DEVICES=6 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_small_model.json --repeat 3 --env_name resource_mountaincar_v8  --base_log_dir /home/zhwang/research/ICML_data/mountain_car_small_model/continuous_resource_15/surprise_small_model_train_freq_low > surprise_15_1.txt 2>&1 &
sleep 15s
CUDA_VISIBLE_DEVICES=6 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_small_model.json --repeat 2 --env_name resource_mountaincar_v8  --base_log_dir /home/zhwang/research/ICML_data/mountain_car_small_model/continuous_resource_15/surprise_small_model_train_freq_low > surprise_15_2.txt 2>&1 &
sleep 15s
CUDA_VISIBLE_DEVICES=7 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision_small_model.json  --repeat 2 --env_name resource_mountaincar_v8  --base_log_dir /home/zhwang/research/ICML_data/mountain_car_small_model/continuous_resource_15/surprise_vision_small_model_train_freq_low > surprise_vision_15_1.txt 2>&1 &
sleep 15s
CUDA_VISIBLE_DEVICES=7 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision_small_model.json --repeat 3 --env_name resource_mountaincar_v8  --base_log_dir /home/zhwang/research/ICML_data/mountain_car_small_model/continuous_resource_15/surprise_vision_small_model_train_freq_low > surprise_vision_15_2.txt 2>&1 &
...
CUDA_VISIBLE_DEVICES=3 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision_small_model.json --env_name resource_mountaincar_v8  --base_log_dir /home/zhwang/research/ICML_data/mountain_car_small_model/continuous_resource_15/surprise_vision_small_model_train_freq_low > surprise_vision_15_2.txt 2>&1 &
CUDA_VISIBLE_DEVICES=3 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_small_model.json --env_name resource_mountaincar_v8  --base_log_dir /home/zhwang/research/ICML_data/mountain_car_small_model/continuous_resource_15/surprise_small_model_train_freq_low > surprise_15_2.txt 2>&1 &
