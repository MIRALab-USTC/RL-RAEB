...
CUDA_VISIBLE_DEVICES=0 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise.json --env_name ant_corridor_env_4 --repeat 3 --alg_type surprise  --base_log_dir /home/zhwang/research/ICML2021_Finaldata/reproducing/ant_corridor_env_4/surprise > surprise1.txt 2>&1 &
sleep 15s
CUDA_VISIBLE_DEVICES=0 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise.json --env_name ant_corridor_env_5 --repeat 3 --alg_type surprise  --base_log_dir /home/zhwang/research/ICML2021_Finaldata/reproducing/ant_corridor_env_5/surprise > surprise2.txt 2>&1 &
sleep 15s
CUDA_VISIBLE_DEVICES=1 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise.json --env_name ant_corridor_env_6 --repeat 3 --alg_type surprise  --base_log_dir /home/zhwang/research/ICML2021_Finaldata/reproducing/ant_corridor_env_6/surprise > surprise3.txt 2>&1 &
sleep 15s

CUDA_VISIBLE_DEVICES=1 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise.json --env_name ant_corridor_env_4 --repeat 3 --alg_type information_gain --ensemble_size 32  --base_log_dir /home/zhwang/research/ICML2021_Finaldata/reproducing/ant_corridor_env_4/JDRX > JDRX1.txt 2>&1 &
sleep 15s
CUDA_VISIBLE_DEVICES=2 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise.json --env_name ant_corridor_env_5 --repeat 3 --alg_type information_gain --ensemble_size 32  --base_log_dir /home/zhwang/research/ICML2021_Finaldata/reproducing/ant_corridor_env_5/JDRX > JDRX2.txt 2>&1 &
sleep 15s
CUDA_VISIBLE_DEVICES=2 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise.json --env_name ant_corridor_env_6 --repeat 3 --alg_type information_gain --ensemble_size 32  --base_log_dir /home/zhwang/research/ICML2021_Finaldata/reproducing/ant_corridor_env_6/JDRX > JDRX3.txt 2>&1 &
sleep 15s
# CUDA_VISIBLE_DEVICES=3 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/sac/sac.json --env_name ant_corridor_env_4 --repeat 3  --base_log_dir /home/zhwang/research/ICML2021_Finaldata/reproducing/ant_corridor_env_4/sac > sac1.txt 2>&1 &
# sleep 15s
# CUDA_VISIBLE_DEVICES=3 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/sac/sac.json --env_name ant_corridor_env_5 --repeat 3  --base_log_dir /home/zhwang/research/ICML2021_Finaldata/reproducing/ant_corridor_env_5/sac > sac2.txt 2>&1 &
# sleep 15s
# CUDA_VISIBLE_DEVICES=4 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/sac/sac.json --env_name ant_corridor_env_6 --repeat 3  --base_log_dir /home/zhwang/research/ICML2021_Finaldata/reproducing/ant_corridor_env_6/sac > sac3.txt 2>&1 &
# sleep 15s

# CUDA_VISIBLE_DEVICES=4 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision.json --env_name resource_cheetah_corridor_v0  --repeat 1 --num_eval_steps_per_epoch 4000 --alg_type only_resource_bonus  --base_log_dir /home/zhwang/research/ICML2021_Finaldata/ablation/component/resource_cheetah_corridor_v0/only_resource_bonus  > only_resource_bonus1.txt 2>&1 &
# sleep 15s
...
# sleep 15s
# CUDA_VISIBLE_DEVICES=5 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision.json --env_name resource_cheetah_corridor_v0  --repeat 1 --num_eval_steps_per_epoch 4000 --alg_type only_resource_bonus  --base_log_dir /home/zhwang/research/ICML2021_Finaldata/ablation/component/resource_cheetah_corridor_v0/only_resource_bonus  > only_resource_bonus3.txt 2>&1 &
# sleep 15s
# CUDA_VISIBLE_DEVICES=6 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision.json --env_name resource_mountaincar_v0  --repeat 1 --num_eval_steps_per_epoch 4000 --alg_type only_resource_bonus  --base_log_dir /home/zhwang/research/ICML2021_Finaldata/ablation/component/resource_mountaincar_v0/only_resource_bonus  > only_resource_bonus4.txt 2>&1 &
# sleep 15s
# CUDA_VISIBLE_DEVICES=6 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision.json --env_name resource_mountaincar_v0   --repeat 1 --num_eval_steps_per_epoch 4000 --alg_type only_resource_bonus  --base_log_dir /home/zhwang/research/ICML2021_Finaldata/ablation/component/resource_mountaincar_v0/only_resource_bonus  > only_resource_bonus5.txt 2>&1 &
# sleep 15s
# CUDA_VISIBLE_DEVICES=7 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision.json --env_name resource_mountaincar_v0  --repeat 1 --num_eval_steps_per_epoch 4000 --alg_type only_resource_bonus  --base_log_dir /home/zhwang/research/ICML2021_Finaldata/ablation/component/resource_mountaincar_v0/only_resource_bonus  > only_resource_bonus6.txt 2>&1 &


# sleep 9h

# CUDA_VISIBLE_DEVICES=7 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision.json --env_name resource_cheetah_corridor_v0 --repeat 2 --alg_type surprise --int_coeff 0.1 --base_log_dir /home/zhwang/research/ICML2021_Finaldata/ablation/sensitivity/resource_cheetah_corridor_v0/raeb_int_01 > raeb_int_011.txt 2>&1 &
# sleep 15s
# CUDA_VISIBLE_DEVICES=7 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision.json --env_name resource_cheetah_corridor_v0 --repeat 2 --alg_type surprise --int_coeff 0.1 --base_log_dir /home/zhwang/research/ICML2021_Finaldata/ablation/sensitivity/resource_cheetah_corridor_v0/raeb_int_01 > raeb_int_012.txt 2>&1 &
# sleep 15s
# CUDA_VISIBLE_DEVICES=6 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision.json --env_name resource_cheetah_corridor_v0 --repeat 2 --alg_type surprise --int_coeff 0.02 --base_log_dir /home/zhwang/research/ICML2021_Finaldata/ablation/sensitivity/resource_cheetah_corridor_v0/raeb_int_002 > raeb_int_0021.txt 2>&1 &
# sleep 15s
# CUDA_VISIBLE_DEVICES=6 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision.json --env_name resource_cheetah_corridor_v0 --repeat 2 --alg_type surprise --int_coeff 0.02 --base_log_dir /home/zhwang/research/ICML2021_Finaldata/ablation/sensitivity/resource_cheetah_corridor_v0/raeb_int_002 > raeb_int_0022.txt 2>&1 &
# sleep 15s
# CUDA_VISIBLE_DEVICES=5 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision.json --env_name resource_mountaincar_v0    --repeat 2 --alg_type surprise --int_coeff 0.1 --base_log_dir /home/zhwang/research/ICML2021_Finaldata/ablation/sensitivity/resource_mountaincar_v0/raeb_int_01 > raeb_int_013.txt 2>&1 &
# sleep 15s
# CUDA_VISIBLE_DEVICES=5 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision.json --env_name resource_mountaincar_v0    --repeat 2 --alg_type surprise --int_coeff 0.1 --base_log_dir /home/zhwang/research/ICML2021_Finaldata/ablation/sensitivity/resource_mountaincar_v0/raeb_int_01 > raeb_int_014.txt 2>&1 &
# sleep 15s
# CUDA_VISIBLE_DEVICES=4 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision.json --env_name resource_mountaincar_v0    --repeat 4 --alg_type surprise --int_coeff 0.02 --base_log_dir /home/zhwang/research/ICML2021_Finaldata/ablation/sensitivity/resource_mountaincar_v0/raeb_int_002 > raeb_int_0023.txt 2>&1 &
# sleep 15s

# CUDA_VISIBLE_DEVICES=4 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision.json --env_name resource_mountaincar_v0    --repeat 2 --alg_type surprise --int_coeff 0.02 --base_log_dir /home/zhwang/research/ICML2021_Finaldata/ablation/sensitivity/resource_mountaincar_v0/raeb_int_002 > raeb_int_0024.txt 2>&1 &

# CUDA_VISIBLE_DEVICES=0 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision.json --env_name ant_corridor_resource_env_goal_4_v0_v2 --repeat 1 --alg_type surprise --int_coeff 0.5 --base_log_dir /home/zhwang/research/ICML_data/evaluation/ant_corridor_resource_env_goal_4_v0_v2/surprise_vision > surprise_vision1.txt 2>&1 &
...
# CUDA_VISIBLE_DEVICES=4 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_small_model.json --env_name done_resource_mountaincar_v0 --repeat 2 --alg_type surprise  --base_log_dir /home/zhwang/research/ICML_data/abalation/with_done/done_resource_mountaincar_v0/surprise > surprise5.txt 2>&1 &
# sleep 15s
