...
sleep 15s
CUDA_VISIBLE_DEVICES=4 nohup xvfb-run -a -s "-screen 0 1400x900x24" python scripts/run.py configs/surprise-based/surprise_vision.json --env_name cheetah_corridor_fuel_done_32_goal9_v3 --repeat 3 --base_log_dir /home/zhwang/ICML_TO_IJCAI_data/data/envs_fuel_fix_r_done_bug/cheetah/surprise_vision_fuel_32 > surprise_vision_fuel_32.txt 2>&1 &
sleep 15s
