...
LEGENDORDER = ["rbc1", "rbc001", "rbc05"]

EnvName = ["delivery_ant"]
...
def alg_name_to_legend(alg_name):
    dic = {
        "rbc1": "$coefficient=1$",
        "rbc001": "$coefficient=0.01$",
        "rbc05": "$coefficient=0.5$"
    }
...
def get_plot_data_from_single_experiment(file_name, algo_name):
    ...
    dic_y = {
        "rbc1": "evaluation/Average Returns",
        "rbc001": "evaluation/Average Returns",
        "rbc05": "evaluation/Average Returns"
    }
            
    dic_x_1 = {
        "rbc1": "exploration/num steps total",
        "rbc001": "exploration/num steps total",
        "rbc05": "exploration/num steps total"
    }
...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_dir", type=str, default="/home/zhwang/ICML_TO_IJCAI/data/IJCAI22_rebuttal/sensitivity_surprise_rb")
    ...
    parser.add_argument("--fig_name", type=str, default="surprise_rb_sensitivity_delivery_ant.pdf")
    parser.add_argument("--n_data", type=int, default=100)
    parser.add_argument("--w", type=float, default=13)
