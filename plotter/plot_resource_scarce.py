...
def env_name_to_figure_name(env_name):
    dic = {
        ...
        "resources_scarce": "Mountain Car"
    }
    return dic[env_name] if env_name in dic else env_name

def alg_name_to_initial_resources(alg_name):
    dic = {
        "resources_5": 5.0,
        "resources_10": 10.0,
        "resources_25": 25.0
...
def alg_name_to_legend(alg_name):
    dic = {
        "resources_5": "$I(s_0)=5$",
        "resources_10": "$I(s_0)=10$",
        "resources_25": "$I(s_0)=25$"
    }
...
def get_plot_data_from_single_experiment(file_name, algo_name):
    ...
    dic_y = {
        "resources_5": "evaluation/Average Returns",
        "resources_10": "evaluation/Average Returns",
        "resources_25": "evaluation/Average Returns"
    }
            
    dic_x_1 = {
        "resources_5": "exploration/num steps total",
        "resources_10": "exploration/num steps total",
        "resources_25": "exploration/num steps total"
    }
    ...
    data_y = data_y / (100.0 * alg_name_to_initial_resources(algo_name))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_dir", type=str, default="/home/zhwang/research/ICML2021_Finaldata/final_data_211226/inefficient_exploration")
    ...
    parser.add_argument("--column_y", type=str, default="Average score")
    parser.add_argument("--fig_name", type=str, default="resource_scarce.pdf")
