...
LEGENDORDER = ["surprise_vison_int01", "surprise_vison_int002", "surprise_vison_int005", "int_005", "int_002", "surprise"]
...
def env_name_to_figure_name(env_name):
    dic = {
        ...
        "delivert_ant": "Delivery Ant"
    }
    return dic[env_name] if env_name in dic else env_name

def alg_name_to_legend(alg_name):
    dic = {
        "surprise_vison_int01": r"RAEB $\beta =0.5$",
        "surprise_vison_int002": r"RAEB $\beta =0.1$",
        "surprise_vison_int005": r"RAEB $\beta =0.25$",
        "int_005": r"RAEB $\beta =0.05$",
        "int_002": r"RAEB $\beta =0.02$",
        "surprise": "Surprise"
    }
...
def get_plot_data_from_single_experiment(file_name, algo_name):
    ...
    dic_y = {
        ...
        "int_005": "evaluation/Average Returns",
        "int_002": "evaluation/Average Returns",
    ...
    dic_x_1 = {
        ...
        "surprise_vison_int005": "exploration/num steps total",
        "int_005": "exploration/num steps total",
        "int_002": "exploration/num steps total",
        "surprise": "exploration/num steps total"
    }
    
    dic_x_2 = {
        "surprise_vison_int01": "Epoch",
        "surprise_vison_int002": "Epoch",
...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_dir", type=str, default="/home/zhwang/ICML_TO_IJCAI/data/IJCAI22_rebuttal/sensitivity_beta")
    ...
    parser.add_argument("--fig_name", type=str, default="beta_delivery_ant.pdf")
