...
MEDIUMFONTSIZE = 28
XLimit = {
    'electric_delivery_ant': 1e6,
    'electric_delivery_car': 1e6,
    'electric_delivery_cheetah': 1e6
}
...
LEGENDORDER = ["raeb", "surprise", "jdrx", "sac", "simhash"]
...
def env_name_to_figure_name(env_name):
    dic = {
        "electric_delivery_ant": "Electric Delivery Ant",
        "electric_delivery_cheetah": "Electric Delivery Half-Cheetah",
        "electric_delivery_car": "Electric Delivery Mountain Car"
    }
...
def get_plot_data_from_single_experiment(file_name, algo_name):
    ...
    dic_x_1 = {
        ...
        "surprise": "exploration/num steps total",
...
def run_plot(args):
    ...
    ax2 = plt.subplot(gs[0, 2]) # cheetah to 4 cheetah to 5 
    ax3 = plt.subplot(gs[0, 1]) # humanoid to 2 
    # ax4 = plt.subplot(gs[0, 2]) # hopper to 3 hopper to 4
    # ax5 = plt.subplot(gs[1, 1]) # invert to 6
    # ax6 = plt.subplot(gs[1, 0]) # ant to 1
...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_dir", type=str, default="/home/zhwang/ICML_TO_IJCAI/data/IJCAI22_rebuttal/evaluation")
    ...
    parser.add_argument("--fig_name", type=str, default="comparison_evaluation_electric_delievry.pdf")
