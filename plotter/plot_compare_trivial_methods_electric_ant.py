...
COLORS = {"surprise_vision": "orangered"}

LEGENDORDER = ["surprise_vision", "surprise_resource_bonus", "sac_resource_bonus"]
...
def alg_name_to_legend(alg_name):
    dic = {
        ...
        "surprise_resource_bonus": "SRB",
        "src": "SFP",
        "sac_resource_bonus": "SACRB",
        "sac_resource_costs": "SACFP"
    }
...
def get_plot_data_from_single_experiment(file_name, algo_name):
    ...
    dic_y = {
        ...
        "sac_resource_bonus": "evaluation/Average Returns",
        "sac_resource_costs": "evaluation/Average Returns"
    }
            
    dic_x_1 = {
        "surprise_vision": "exploration/num steps total",
        "surprise_resource_bonus": "exploration/num steps total",
        "src": "exploration/num steps total",
        "sac_resource_bonus": "exploration/num steps total",
        "sac_resource_costs": "exploration/num steps total"
    }
    ...
    dic_x_2 = {
        ...
        "src": "Epoch",
        "sac_resource_bonus": "Epoch",
        "sac_resource_costs": "Epoch"
    }
...
def run_plot(args):
    ...
    for i, env_name in enumerate(os.listdir(args.log_dir)):   
        ...
        if env_name == "ant_corridor_resource_env_goal_4_v0" or env_name == "electric_mountain_car":
            continue
...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_dir", type=str, default="/home/zhwang/research/ICML2021_Finaldata/final_data_211226/compare_with_trivial")
    ...
    parser.add_argument("--fig_name", type=str, default="compare_trivial_electric_car.pdf")
