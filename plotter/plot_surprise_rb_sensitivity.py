...
XLimit = {
    "electric_ant": 1e6,
    "electric_mountain_car": 1e6
}

colors = ["lightseagreen", "cornflowerblue", "orchid", "gray", "darkseagreen", "goldenrod", "darkorange", "mediumorchid", "darkturquoise" ]
COLORS = {"surprise_resource_bonus": "orangered"}

LEGENDORDER = ["surprise_resource_bonus", "surprise_resource_bonus_rbc1", "surprise_resource_bonus_rbc001", "surprise_resource_bonus_rbc05"]
...
def env_name_to_figure_name(env_name):
    dic = {
        "electric_mountain_car": "Electric Mountain Car"
    }
    return dic[env_name] if env_name in dic else env_name

def alg_name_to_legend(alg_name):
    dic = {
        "surprise_resource_bonus": "$coefficient=0.1$",
        "surprise_resource_bonus_rbc1": "$coefficient=1$",
        "surprise_resource_bonus_rbc001": "$coefficient=0.01$",
        "surprise_resource_bonus_rbc05": "$coefficient=0.5$"
    }
...
def get_plot_data_from_single_experiment(file_name, algo_name):
    ...
    dic_y = {
        "surprise_resource_bonus": "evaluation/Average Returns",
        "surprise_resource_bonus_rbc1": "evaluation/Average Returns",
        "surprise_resource_bonus_rbc001": "evaluation/Average Returns",
        "surprise_resource_bonus_rbc05": "evaluation/Average Returns"
    }
            
    dic_x_1 = {
        "surprise_resource_bonus": "exploration/num steps total",
        "surprise_resource_bonus_rbc1": "exploration/num steps total",
        "surprise_resource_bonus_rbc001": "exploration/num steps total",
        "surprise_resource_bonus_rbc05": "exploration/num steps total"
    }
    
    dic_x_2 = {
        "surprise_resource_bonus": "Epoch",
        "surprise_resource_bonus_rbc1": "Epoch",
        "surprise_resource_bonus_rbc001": "Epoch",
        "surprise_resource_bonus_rbc05": "Epoch"
    }
...
def run_plot(args):
    ...
    for i, env_name in enumerate(os.listdir(args.log_dir)):   
        ...
        if env_name == "ant_corridor_resource_env_goal_4_v0":
            continue
...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_dir", type=str, default="/home/zhwang/research/ICML2021_Finaldata/final_data_211226/sensitivity_analysis/surprise_rb")
    ...
    parser.add_argument("--fig_name", type=str, default="surprise_rb_sensitivity_electric_car.pdf")
