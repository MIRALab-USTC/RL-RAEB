...
LEGENDORDER = ["surprise_vision", "surprise", "only_resource_bonus"]
...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_dir", type=str, default="/home/zhwang/research/ICML2021_Finaldata/final_data_211226/component")
    ...
    parser.add_argument("--fig_name", type=str, default="component_electric_ant.pdf")
