...
XLimit = {
    "electric_ant": 1e6,
    "ant_corridor_resource_env_goal_4_v0": 1e6
}

colors = ["lightseagreen", "cornflowerblue", "orchid", "gray", "darkseagreen", "goldenrod", "darkorange", "mediumorchid", "darkturquoise" ]
COLORS = {"surprise_fuel_140_int025": "orangered"}

LEGENDORDER = ["surprise_fuel_140_int025", "surprise_fuel_140_int05", "surprise_fuel_140_int01", "surprise_vision_int005"]
...
def env_name_to_figure_name(env_name):
    dic = {
        ...
        "ant_corridor_resource_env_goal_4_v0": "Delivery Ant"
    }
    return dic[env_name] if env_name in dic else env_name

def alg_name_to_legend(alg_name):
    dic = {
        "surprise_fuel_140_int025": r"$\beta =0.25$",
        "surprise_fuel_140_int05": r"$\beta =0.5$",
        "surprise_fuel_140_int01": r"$\beta =0.1$",
        "surprise_vision_int005": r"$\beta =0.05$"
    }
...
def get_plot_data_from_single_experiment(file_name, algo_name):
    ...
    dic_y = {
        "surprise_fuel_140_int025": "evaluation/Average Returns",
        "surprise_fuel_140_int05": "evaluation/Average Returns",
        "surprise_fuel_140_int01": "evaluation/Average Returns",
        "surprise_vision_int005": "evaluation/Average Returns"
    }
            
    dic_x_1 = {
        "surprise_fuel_140_int025": "exploration/num steps total",
        "surprise_fuel_140_int05": "exploration/num steps total",
        "surprise_fuel_140_int01": "exploration/num steps total",
        "surprise_vision_int005": "exploration/num steps total"
    }
    
    dic_x_2 = {
        "surprise_fuel_140_int025": "Epoch",
        "surprise_fuel_140_int05": "Epoch",
        "surprise_fuel_140_int01": "Epoch",
        "surprise_vision_int005": "Epoch"
    }
...
if __name__ == '__main__':
    ...
    parser.add_argument("--log_dir", type=str, default="/home/zhwang/research/ICML2021_Finaldata/final_data_211226/sensitivity_analysis/beta")
    ...
    parser.add_argument("--fig_name", type=str, default="beta_electric_ant.pdf")
