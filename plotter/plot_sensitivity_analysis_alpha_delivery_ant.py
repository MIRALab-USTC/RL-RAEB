...
COLORS = {"surprise_vision_alpha1": "orangered"}

LEGENDORDER = ["surprise_vision_alpha1", "ant_corridor_resource_env_goal_4_beta1_alpha15", "ant_corridor_resource_env_goal_4_beta1_alpha2", "ant_corridor_resource_env_goal_4_beta1_alpha05"]
...
def alg_name_to_legend(alg_name):
    dic = {
        "surprise_vision_alpha1": r"$\alpha =0.25 I_{max}$",
        "ant_corridor_resource_env_goal_4_beta1_alpha15": r"$\alpha =0.375 I_{max}$",
        "ant_corridor_resource_env_goal_4_beta1_alpha2": r"$\alpha = 0.5 I_{max}$",
        "ant_corridor_resource_env_goal_4_beta1_alpha05": r"$\alpha =0.125 I_{max}$"
    }
...
def get_plot_data_from_single_experiment(file_name, algo_name):
    ...
    dic_y = {
        "surprise_vision_alpha1": "evaluation/Average Returns",
        "ant_corridor_resource_env_goal_4_beta1_alpha15": "evaluation/Average Returns",
        "ant_corridor_resource_env_goal_4_beta1_alpha2": "evaluation/Average Returns",
        "ant_corridor_resource_env_goal_4_beta1_alpha05": "evaluation/Average Returns"
    }
            
    dic_x_1 = {
        "surprise_vision_alpha1": "exploration/num steps total",
        "ant_corridor_resource_env_goal_4_beta1_alpha15": "exploration/num steps total",
        "ant_corridor_resource_env_goal_4_beta1_alpha2": "exploration/num steps total",
        "ant_corridor_resource_env_goal_4_beta1_alpha05": "exploration/num steps total"
    }
    
    dic_x_2 = {
        "surprise_vision_alpha1": "Epoch",
        "ant_corridor_resource_env_goal_4_beta1_alpha15": "Epoch",
        "ant_corridor_resource_env_goal_4_beta1_alpha2": "Epoch",
        "ant_corridor_resource_env_goal_4_beta1_alpha05": "Epoch"
    }
...
if __name__ == '__main__':
    ...
    parser.add_argument("--fig_name", type=str, default="alpha_delivery_ant.pdf")
