...
COLORS = {
    "surprise_fuel_12": "orangered" 
}

LEGENDORDER = ["surprise_fuel_12", "surprise_no_fuel"]
...
def alg_name_to_legend(alg_name):
    dic = {
        "surprise_fuel_12": "Electric Mountain Car",
        "surprise_no_fuel": "Continuous Mountain Car"
    }
...
def get_plot_data_from_single_experiment(file_name, algo_name):
    ...
    dic_y = {
        "surprise_fuel_12": "evaluation/Average Returns",
        "surprise_no_fuel": "evaluation/Average Returns"
    }
            
    dic_x_1 = {
        "surprise_fuel_12": "exploration/num steps total",
        "surprise_no_fuel": "exploration/num steps total"
    }
    
    dic_x_2 = {
        "surprise_fuel_12": "Epoch",
        "surprise_no_fuel": "Epoch"
    }
...
if __name__ == '__main__':
    ...
    parser.add_argument("--fig_name", type=str, default="surprise_car_inefficient_exploration.pdf")
